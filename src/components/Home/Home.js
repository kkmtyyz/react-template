  ...
  return (
    <div className="container-lg mb-5">
      ...
      <div className="row mt-3 mx-3">
        ...
        <div className="col-sm p-0 pe-sm-1">
        ...
        <div className="col-sm p-0 ps-sm-1">
          <div className="container">

            <div className="row">
              <div className="p-0">Check</div>
      ...
      <div className="row mt-3 mx-3">
        <label className="form-label p-0" htmlFor="formRange">Range</label>
      ...
      <div className="row mt-3 mx-3">
        <label className="form-label p-0" htmlFor="formDate">date</label>
